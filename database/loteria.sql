...
CREATE TABLE IF NOT EXISTS `loteria`.`bolao` (
  ...
  INDEX `fk_bolao_usuario1_idx` (`usuario_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `loteria`.`bolao_arquivo` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_bolao_arquivo_bolao_idx` (`bolao_id` ASC) VISIBLE,
  INDEX `fk_bolao_arquivo_arquivo_idx` (`arquivo_id` ASC) VISIBLE,
