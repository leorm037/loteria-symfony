...
CREATE TABLE IF NOT EXISTS `loteria`.`bolao` (
  ...
  `planilha_jogos_csv` INT NOT NULL,
  `comprovante_jogos_pdf` INT NOT NULL,
  PRIMARY KEY (`id`),
  ...
  INDEX `fk_bolao_arquivo_comprovante_jogos_pdf_idx` (`comprovante_jogos_pdf` ASC) VISIBLE,
