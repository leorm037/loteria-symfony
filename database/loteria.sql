...
CREATE TABLE IF NOT EXISTS `loteria`.`bolao` (
  ...
  INDEX `fk_bolao_arquivo_planilha_jogos_csv_idx` (`planilha_jogos_csv` ASC),
  INDEX `fk_bolao_arquivo_comprovante_jogos_pdf_idx` (`comprovante_jogos_pdf` ASC),
...
CREATE TABLE IF NOT EXISTS `loteria`.`apostador` (
  ...
  INDEX `fk_apostador_arquivo_idx` (`arquivo_id` ASC),
