...
/**
 * @phpstan-extends Voter<string, Bolao|Apostador>
 */
class ApostadorVoter extends Voter
{
    ...
    private function canEdit(Apostador $apostador, UserInterface $usuario): bool
    {
        return $usuario === $apostador->getBolaoUsuario() && null === $apostador->getBolaoConcurso()->getDezenas();
    }

    private function canDelete(Apostador $apostador, UserInterface $usuario): bool
    {
        return $usuario === $apostador->getBolaoUsuario() && null === $apostador->getBolaoConcurso()->getDezenas();
    }
}
